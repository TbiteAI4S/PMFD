Shader "MarchingCubes/GPUMarchingCubesRenderStandardMesh"
{
	Properties
	{
	...
	SubShader
	{
        ...
        //ドラゴンボーンの配列
        float3 _MPositions[10];
        float3 _jawPositions[10];
        float3 _neckPositions[10];
        float3 _bodyPositions[10];
        float3 _tailPositions[10];
        float3 _armLeftPositions[20];
		...
		float Sample(float x, float y, float z) {
            ...
            float sp = -sphere(pos - float3(0.8, 0.5, 0.5), 0.04) + 0.5;
            result = smoothMax(result, sp, 14);
            */
            ...
            for (int j = 0; j < 10; j = j + 3) {
                ...
                //float sp1 = -sphere(pos - _jawPositions[j], 0.01);
                //result = smoothMax(result, sp1, 14);

                //float sp2 = -sphere(pos - _neckPositions[j], 0.03);
                //result = smoothMax(result, sp2, 14);
            }
            for (int k = 0; k < 10; k = k + 1) {
                //float sp3 = -sphere(pos - _bodyPositions[k], 0.03);
                //result = smoothMax(result, sp3, 14);
            }
            for (int l = 0; l < 10; l = l + 1) {
                //float sp4 = -sphere(pos - _tailPositions[l], 0.03);
                //result = smoothMax(result, sp4, 14);

                //float sp5 = -sphere(pos - _armLeftPositions[l], 0.03);
                //result = smoothMax(result, sp5, 14);
            }
