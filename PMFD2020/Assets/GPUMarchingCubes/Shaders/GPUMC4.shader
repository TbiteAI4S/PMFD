Shader "MarchingCubes/GPUMC4"
{
        ...
        SubShader
    {
        ...
        float3 _armRightPositions[20];
        float3 _footLeftPositions[20];
        float3 _footRightPositions[20];
        ...
        float Sample(float x, float y, float z) {
            ...
            //arm
            for (int i = 0; i < 20; i++) {
                float sp5 = -sphere(pos - _armLeftPositions[i], 0.03);
                result = smoothMax(result, sp5, 14);

                float sp6 = -sphere(pos - _armRightPositions[i], 0.03);
                result = smoothMax(result, sp6, 14);

                float sp7 = -sphere(pos - _footLeftPositions[i], 0.03);
                result = smoothMax(result, sp7, 14);

                float sp8 = -sphere(pos - _footRightPositions[i], 0.03);
                result = smoothMax(result, sp8, 14);
            }
