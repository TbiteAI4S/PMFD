...
public class GPUMC4 : MonoBehaviour
{
    #region public
    ...
    Vector4[] vector4ArmLeft = new Vector4[20];
    Vector4[] vector4ArmRight = new Vector4[20];
    Vector4[] vector4FootLeft = new Vector4[20];
    Vector4[] vector4FootRight = new Vector4[20];
    ...
    void RenderMesh()
    {
        ...
        for (int i = 0; i < meshs.Length; i++)
        {
            ...
            //テスト
            materials[i].SetVectorArray("_armLeftPosition", vector4ArmLeft);
            materials[i].SetVectorArray("_armRightPositions", vector4ArmRight);
            materials[i].SetVectorArray("_footLeftPositions", vector4FootLeft);
            materials[i].SetVectorArray("_footRightPositions", vector4FootRight);
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            ...
            vector4FootLeft[i] = MakeDragonBone._FootLeftborne[i];
            vector4FootRight[i] = MakeDragonBone._FootRightborne[i];
        }
        for (int i = 0; i < 10; i++)
        {
